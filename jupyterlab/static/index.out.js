...
import {setApp} from '@jupyterlab/application';
...
function main() {
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-code-to-graph-renderer')) {
      disabled.matches.push('@ali/dsw-code-to-graph-renderer');
    } else {
      var module = require('@ali/dsw-code-to-graph-renderer/');
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-python-editor')) {
      disabled.matches.push('@ali/dsw-python-editor');
    } else {
      var module = require('@ali/dsw-python-editor/');
      var extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-demos')) {
      disabled.matches.push('@ali/dsw-demos');
    } else {
      module = require('@ali/dsw-demos/');
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-theme')) {
      disabled.matches.push('@ali/dsw-theme');
    } else {
      module = require('@ali/dsw-theme/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ali/DSW-light')) {
      disabled.matches.push('@ali/DSW-light');
    } else {
      module = require('@ali/DSW-light/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-fetch')) {
      disabled.matches.push('@ali/dsw-fetch');
    } else {
      module = require('@ali/dsw-fetch/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ali/dsw-tianchi-extension')) {
      disabled.matches.push('@ali/dsw-tianchi-extension');
    } else {
      module = require('@ali/dsw-tianchi-extension/');
      extension = module.default;
  ...
  try {
    ...
    if (isDisabled('@ali/fast-neural-network-notebook-extension')) {
      disabled.matches.push('@ali/fast-neural-network-notebook-extension');
    } else {
      module = require('@ali/fast-neural-network-notebook-extension/');
      extension = module.default;
